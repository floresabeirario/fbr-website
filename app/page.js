...
export default function Home() {
  ...
  // Forçar scroll para o topo no refresh
  useEffect(() => {
  ...
  return (
    <main style={{ color: '#1a1a1a', backgroundColor: '#FCFBF9' }}>
      ...
      <section style={{ height: '100vh', position: 'relative', overflow: 'hidden', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        ...
        <div style={{ zIndex: 2, textAlign: 'center', color: '#fff', padding: '0 20px' }}>
          <motion.h1 
            ...
            style={{ fontSize: 'clamp(3rem, 10vw, 5.5rem)', fontFamily: "'TAN-MEMORIES', serif", marginBottom: '0', fontWeight: '400' }}
          >
            Flores à Beira-Rio
          </motion.h1>
          <motion.p 
      ...
      <section style={{ padding: '80px 20px', backgroundColor: '#1a1a1a', color: '#FCFBF9', textAlign: 'center' }}>
        <h2 style={{ fontFamily: "'TAN-MEMORIES', serif", fontSize: '2.8rem', marginBottom: '40px' }}>O que dizem as nossas noivas</h2>
        <motion.div 
          initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}
          style={{ maxWidth: '800px', margin: '0 auto' }}
        >
          <p style={{ fontSize: '1.5rem', lineHeight: '1.4', fontFamily: "'TAN-MEMORIES', serif" }}>
      ...
      <section style={{ padding: '100px 20px', maxWidth: '1200px', margin: '0 auto' }}>
        <h2 style={{ fontFamily: "'TAN-MEMORIES', serif", fontSize: '3rem', textAlign: 'center', marginBottom: '60px' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '40px' }}>
          {[
            ...
            <div key={i} style={{ borderLeft: '1px solid #1a1a1a', paddingLeft: '25px' }}>
              ...
              <h3 style={{ fontFamily: "'TAN-MEMORIES', serif", fontSize: '2rem', margin: '15px 0' }}>{step.t}</h3>
      ...
      <section style={{ padding: '100px 20px', textAlign: 'center', backgroundColor: '#f9f6f2' }}>
        <div style={{ maxWidth: '800px', margin: '0 auto' }}>
          <h2 style={{ fontFamily: "'TAN-MEMORIES', serif", fontSize: '3rem', marginBottom: '25px' }}>Beira-Rio: Preservação Consciente</h2>
      ...
      <section style={{ padding: '100px 20px', maxWidth: '1200px', margin: '0 auto' }}>
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '80px' }}>
          <div>
            <h3 style={{ fontFamily: "'TAN-MEMORIES', serif", fontSize: '2.5rem', marginBottom: '20px' }}>Ofereça um Vale-Presente</h3>
          ...
          <div>
            <h3 style={{ fontFamily: "'TAN-MEMORIES', serif", fontSize: '2.5rem', marginBottom: '20px' }}>Sessão de Esclarecimento</h3>
      ...
      <footer style={{ position: 'relative', backgroundColor: '#1a1a1a', color: '#FCFBF9', marginTop: '100px' }}>
        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '80px 20px 40px 20px', textAlign: 'center' }}>
          <h2 style={{ fontFamily: "'TAN-MEMORIES', serif", fontSize: '3.5rem', marginBottom: '40px' }}>Flores à Beira-Rio</h2>
