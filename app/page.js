...
export default function Home() {
  ...
  return (
    <main style={{ backgroundColor: '#FCFBF9' }}>
      ...
      <section style={{ height: '100vh', position: 'relative', overflow: 'hidden', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        ...
        <div style={{ zIndex: 2, textAlign: 'center', color: '#fff', padding: '0 20px' }}>
          <motion.h1 
            ...
            style={{ fontSize: 'clamp(3.5rem, 12vw, 6rem)', marginBottom: '0' }}
          >
            Flores à Beira-Rio
          </motion.h1>
          <motion.p 
            ...
            style={{ fontSize: '0.75rem', letterSpacing: '5px', textTransform: 'uppercase', opacity: 0.8, marginTop: '15px', fontWeight: '400' }}
          >
      ...
      {/* 2. GOOGLE REVIEWS (Uso do Itálico aqui!) */}
      <section style={{ padding: '100px 20px', backgroundColor: '#1a1a1a', color: '#FCFBF9', textAlign: 'center' }}>
        ...
        >
          ...
          <div style={{ marginTop: '30px', opacity: 0.5, fontSize: '0.7rem', letterSpacing: '2px', fontWeight: '400' }}>GOOGLE REVIEWS ★★★★★</div>
        </motion.div>
      </section>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '60px' }}>
          {[
            ...
            <div key={i} style={{ borderLeft: '1px solid #1a1a1a', paddingLeft: '30px' }}>
              <span style={{ fontSize: '0.7rem', fontWeight: '500', opacity: 0.3 }}>{step.n}</span>
      ...
      <section style={{ padding: '120px 20px', textAlign: 'center', backgroundColor: '#F4F1EE' }}>
        <div style={{ maxWidth: '850px', margin: '0 auto' }}>
          ...
          <p style={{ fontSize: '1.1rem', lineHeight: '1.9', color: '#333' }}>
            ...
            Uma técnica centenária, 100% orgânica e feita para durar gerações, sem a toxicidade dos químicos.
          </p>
        </div>
      </section>
      ...
      <section style={{ padding: '120px 20px', maxWidth: '1200px', margin: '0 auto' }}>
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(350px, 1fr))', gap: '100px' }}>
          <div>
            ...
            <p style={{ marginBottom: '40px', color: '#555', lineHeight: '1.7' }}>Deixe que os noivos escolham a preservação ao seu gosto. O presente mais delicado para um dia inesquecível.</p>
            <button style={{ backgroundColor: '#1a1a1a', color: '#fff', padding: '20px 40px', border: 'none', cursor: 'pointer', width: '100%', letterSpacing: '2px', textTransform: 'uppercase', fontSize: '0.75rem', fontWeight: '500' }}>Oferecer Vale-Presente</button>
          </div>
          <div>
            <h3 style={{ fontSize: '2.6rem', marginBottom: '25px' }}>Videochamada</h3>
            <p style={{ marginBottom: '40px', color: '#555', lineHeight: '1.7' }}>Agende uma sessão gratuita de 30 min para entender o processo e escolher os produtos que melhor se adequam a si.</p>
            <button style={{ backgroundColor: 'transparent', color: '#1a1a1a', padding: '20px 40px', border: '1px solid #1a1a1a', cursor: 'pointer', width: '100%', letterSpacing: '2px', textTransform: 'uppercase', fontSize: '0.75rem', fontWeight: '500' }}>Agendar Agora</button>
          </div>
        </div>
      </section>
      ...
      <footer style={{ position: 'relative', backgroundColor: '#1a1a1a', color: '#FCFBF9', marginTop: '120px' }}>
        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '100px 20px 50px 20px', textAlign: 'center' }}>
          ...
          <div style={{ borderTop: '1px solid rgba(255,255,255,0.05)', paddingTop: '50px' }}>
            <div style={{ display: 'flex', justifyContent: 'center', gap: '40px', fontSize: '0.7rem', opacity: 0.5, textTransform: 'uppercase', letterSpacing: '2px', marginBottom: '25px' }}>
            ...
            <p style={{ fontSize: '0.65rem', opacity: 0.3, letterSpacing: '1.5px' }}>© 2026 FLORES À BEIRA-RIO. AVEIRO, PORTUGAL.</p>
          </div>
        </div>
      </footer>
    </main>
