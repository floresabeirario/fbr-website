...
const IconEmail = () => <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"></path><polyline points="22,6 12,13 2,6"></polyline></svg>;
        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '100px 40px 40px' }}>
          ...
          <div style={{ borderTop: '1px solid rgba(255,255,255,0.1)', paddingTop: '30px', display: 'flex', justifyContent: 'space-between', flexWrap: 'wrap', gap: '20px', fontSize: '0.65rem', letterSpacing: '1px', opacity: 0.5 }}>
            ...
            <div style={{ display: 'flex', gap: '25px' }}>
              <a href="/politica-de-privacidade" className="nav-link" style={{ color: footerText }}>PRIVACIDADE</a>
