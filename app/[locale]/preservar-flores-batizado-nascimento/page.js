...
function buildSchema(locale) {
  ...
  const howTo = {
    ...
    step: isEN
      ? [
          { "@type": "HowToStep", position: 1, name: "Contact us within days of the celebration", text: "Get in touch as soon as possible, ideally within 1 to 3 days after the baptism or birth (up to 5 days). The flowers are at their best for preservation." },
      ...
      : [
          { "@type": "HowToStep", position: 1, name: "Contactar nos primeiros dias após a celebração", text: "Entre em contacto assim que possível, idealmente nos primeiros 1 a 3 dias após o batizado ou nascimento (até 5 dias). As flores estão no ponto óptimo para preservação." },
  ...
  const faqPT = [
    { q: "Quando devo entregar as flores do batizado ou nascimento?", a: "O mais cedo possível, até 5 dias após a celebração. Quanto mais frescas as flores, melhor o resultado da prensagem." },
  ...
  const faqEN = [
    { q: "When should I hand in the flowers after the baptism or birth?", a: "As soon as possible, within 5 days of the celebration. The fresher the flowers, the better the pressing result." },
