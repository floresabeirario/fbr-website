...
export default function RecriacaoClient({ precos = PRECOS_FALLBACK }) {
  ...
  return (
    <div style={{ backgroundColor: "#FAF5EC", overflowX: "clip" }}>
      ...
      {/* 1. HERO */}
      <PageHero
        src="/recriacao-bouquet-noiva-quadro.webp"
          ...
          <m.div initial={{ opacity: 0, y: 24 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.8, ease: [0.16, 1, 0.3, 1] }}
            ...
            <div className="pricing-cols" style={{ marginBottom: "22px" }}>
              ...
              <div style={{ backgroundColor: "rgba(196,164,74,0.07)", borderRadius: "12px", padding: "20px 16px", border: "1px solid rgba(196,164,74,0.14)" }}>
                ...
                <p style={{ color: "#5A4A30", fontSize: "0.85rem", lineHeight: 1.7, margin: 0 }}>{t("preservacaoMolduraDesc", { quadro30x40: precos.quadro30x40 })}</p>
              </div>
            </div>
