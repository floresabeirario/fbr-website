    ...
    <main style={{ backgroundColor: "#FAF7F0", minHeight: "100vh" }}>
      <section style={{ paddingTop: "clamp(140px,18vw,200px)", paddingBottom: "clamp(80px,12vw,140px)", paddingLeft: "20px", paddingRight: "20px", background: "linear-gradient(175deg, #EDF2E8 0%, #FAF7F0 100%)", textAlign: "center" }}>
        <motion.div initial={{ opacity: 0, y: 22 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, ease: [0.16, 1, 0.3, 1] }} style={{ maxWidth: "640px", margin: "0 auto" }}>
          <span style={{ display: "block", fontSize: "0.58rem", fontWeight: 700, letterSpacing: "3.5px", textTransform: "uppercase", color: "#C4846B", marginBottom: "14px", fontFamily: "Roboto, sans-serif" }}>Pedido de Casamento</span>
          <h1 style={{ fontFamily: "'TAN-MEMORIES', serif", fontSize: "clamp(2.6rem,8vw,5rem)", color: "#1E2D2A", margin: "0 0 20px", lineHeight: 1.02 }}>Preservar Flores do<br/><em style={{ fontStyle: "italic", color: "#3D6B5E" }}>Pedido de Casamento</em></h1>
          <p style={{ color: "#5A6B60", fontSize: "clamp(0.95rem,2vw,1.08rem)", lineHeight: 1.88, maxWidth: "520px", margin: "0 auto 36px" }}>As flores do pedido de casamento marcam o início de uma história. Preserve esse momento numa obra de arte botânica que acompanha toda a vossa vida juntos.</p>
