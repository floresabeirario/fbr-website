...
const SOCIALS = [
  ...
  },
  {
    icon: <IconTikTok />,
    label: "TikTok",
    href: "https://www.tiktok.com/@floresabeirario",
      ...
      <style dangerouslySetInnerHTML={{ __html: `
        * { box-sizing: border-box; }
        ...
        @media (min-width: 400px) {
          .socials-row { grid-template-columns: repeat(4, 1fr); }
        }
        ...
        <div style={{
          ...
          <div className="contact-split" style={{ gap: "clamp(40px,6vw,80px)", alignItems: "center" }}>
            ...
            >
              ...
              {[
                { icon: <IconWhatsApp />, label: "+351 934 680 300", sub: "Respondemos em 24 horas", href: "https://wa.me/351934680300", color: "#25D366" },
                { icon: <IconEmail />, label: "info@floresabeirario.pt", sub: "Resposta em 72 horas", href: "mailto:info@floresabeirario.pt", color: "#8BA888" },
              ].map((item, i) => {
