...
// ─── SVG Icons preenchidos/sólidos para secção Tracking ──────────────────────
const IconFlower = () => (
      ...
      >
        ...
        <div
          style={{
            ...
            backgroundColor: "rgba(61,107,94,0.8)", color: "#FAF7F0",
            padding: "5px 14px", borderRadius: "50px",
            fontSize: "0.72rem", fontWeight: "700", letterSpacing: "2px",
            textTransform: "uppercase", fontFamily: "Roboto, sans-serif",
            backdropFilter: "blur(6px)",
            opacity: position < 88 ? 1 : 0, transition: "opacity 0.2s",
            pointerEvents: "none",
          }}
        >
          Depois
        ...
        <div
          style={{
            ...
            width: "2px", background: "rgba(250,247,240,0.9)",
            pointerEvents: "none", willChange: "left",
          }}
        />

        {/* Handle com seta bidirecional */}
        <div
          style={{
        ...
        <div
          style={{
            ...
            backgroundColor: "rgba(0,0,0,0.42)", color: "#FAF7F0",
...
// ─── Step Card com número sobreposto na foto ──────────────────────────────────
    ...
    >
      ...
      <div
        ...
        style={{
          ...
          background: "linear-gradient(to bottom, rgba(15,28,22,0.52) 0%, transparent 55%)",
        }}
      />
      <span
        aria-hidden="true"
      ...
      <main style={{ backgroundColor: "#FAF7F0", overflowX: "hidden", position: "relative" }}>
        <style dangerouslySetInnerHTML={{
          ...
          * { box-sizing: border-box; }
          ...
          @media (min-width: 640px) {
            .steps-grid { grid-template-columns: repeat(3,1fr); gap: 0 28px; }
          }
          ...
          /* Botões CTA split — mesma altura exacta */
          .cta-btn-equal {
            display: inline-flex;
            align-items: center;
            justify-content: center;
        ...
        >
          ...
          <div
            ...
            style={{
              position: "absolute", inset: 0,
              background: "linear-gradient(to bottom, rgba(15,30,26,0.25) 0%, rgba(15,30,26,0.55) 60%, rgba(15,30,26,0.78) 100%)",
            }}
          />
          ...
          >
            ...
            >
              <a href={FORM_URL} target="_blank" rel="noopener noreferrer" className="hero-btn">
                Reservar Data
              </a>
            </motion.div>
          </motion.div>
        ...
        <section
          ...
          style={{
            ...
            background: "linear-gradient(180deg, rgba(29,52,44,0.05) 0%, #FAF7F0 100%)",
        ...
        >
          <div style={{ maxWidth: "1180px", margin: "0 auto" }}>
            ...
            <div className="steps-buttons" style={{ marginTop: "56px" }}>
        ...
        <section
          ...
          style={{
            padding: "88px 20px",
            background: "linear-gradient(180deg, #FAF7F0 0%, #F8F2E4 100%)",
            position: "relative", zIndex: 1,
          }}
        >
            ...
            <div className="tracking-grid">
              ...
              >
                ...
                >
                  ...
                  <div
                    style={{
                      position: "relative", zIndex: 1,
                      backgroundColor: "#1E2D2A", borderRadius: "42px", padding: "14px 10px",
                      boxShadow: "0 32px 80px rgba(30,45,42,0.35), 0 0 0 1px rgba(255,255,255,0.06), inset 0 0 0 1px rgba(255,255,255,0.04)",
                    }}
                  >
                    <div
                      style={{ display: "flex", justifyContent: "center", marginBottom: "10px", gap: "6px", alignItems: "center" }}
                      aria-hidden="true"
                    >
                    ...
                    <div
                      style={{
                        ...
                        backgroundColor: "#0f1f1a", aspectRatio: "9/19.5", position: "relative",
                      }}
                    >
                      <video
              ...
              >
                ...
                <p style={{ color: "#5A6B60", lineHeight: 1.85, fontSize: "clamp(1rem,2vw,1.1rem)", margin: "0 0 36px" }}>
                  Após a reserva estar confirmada, partilhamos consigo cada etapa do processo,
                  da receção das flores à composição final. Pode acompanhar tudo em tempo real,
                  ...
                  {[
                    ...
                    <motion.div
                      ...
                      style={{
                        ...
                        padding: "18px 0",
                        borderBottom: i === 0 ? "1px solid rgba(61,107,94,0.12)" : "none",
                      }}
                    >
                      <div
                        style={{
                          ...
                          display: "flex", alignItems: "center", justifyContent: "center",
                          color: item.iconColor, flexShrink: 0, marginTop: "2px",
                        }}
                      >
                        {item.icon}
                      </div>
        ...
        {/* ════ 7. CARTÃO-OFERTA — tema azul/violeta ════ */}
        <section
        ...
        >
          ...
          <div
            ...
            style={{
              position: "absolute", inset: 0,
              background: "linear-gradient(110deg, rgba(38,34,80,0.91) 0%, rgba(52,46,110,0.82) 45%, rgba(38,34,80,0.5) 100%)",
            }}
          />
              ...
              >
                <div
                  style={{
                    ...
                    background: "rgba(160,148,220,0.18)",
                    border: "1px solid rgba(160,148,220,0.35)",
                    borderRadius: "100px", padding: "6px 16px", marginBottom: "20px",
                  }}
                >
                  <span style={{ fontSize: "0.72rem", fontWeight: "700", letterSpacing: "2.5px", textTransform: "uppercase", color: "#C5BCEF", fontFamily: "Roboto, sans-serif" }}>
                ...
                >
                  Ofereça memórias<br />
                  <em style={{ fontStyle: "italic", color: "#C5BCEF" }}>que duram para sempre</em>
                </h2>
                ...
                <a
                  ...
                  style={{
                    ...
                    backgroundColor: "#A094DC", color: "#FAF7F0",
                    padding: "14px 34px", borderRadius: "100px",
                    textDecoration: "none", fontWeight: "700",
                    fontSize: "0.8rem", letterSpacing: "1.8px",
                    textTransform: "uppercase", fontFamily: "Roboto, sans-serif",
                    transition: "all 0.3s ease",
                    boxShadow: "0 6px 24px rgba(100,88,180,0.4)",
                    minHeight: "48px",
                  }}
        ...
        {/* ════ 8. CTA SPLIT — Apoio primeiro, Noivas segundo ════ */}
        <div className="cta-split">
          ...
          >
            <div style={{ maxWidth: "440px", margin: "0 auto", width: "100%" }}>
              ...
              <p style={{ color: "#5A6B60", fontSize: "0.97rem", lineHeight: 1.82, margin: "0 0 10px" }}>
                Agende uma sessão de esclarecimento gratuita por videochamada antes de fazer o seu pedido.
              </p>
              <p style={{ color: "#5A6B60", fontSize: "0.92rem", lineHeight: 1.75, margin: "0 0 32px" }}>
              ...
              <div style={{ display: "flex", gap: "12px", justifyContent: "center", flexWrap: "wrap" }}>
                <a
                  href="/contactos"
                  className="cta-btn-equal"
                  style={{ backgroundColor: "#3D6B5E", color: "#FAF7F0", boxShadow: "0 6px 24px rgba(61,107,94,0.28)" }}
                  onMouseEnter={(e) => { e.currentTarget.style.backgroundColor = "#1E2D2A"; e.currentTarget.style.transform = "translateY(-3px)"; }}
                  onMouseLeave={(e) => { e.currentTarget.style.backgroundColor = "#3D6B5E"; e.currentTarget.style.transform = "translateY(0)"; }}
                >
                  Contactos
                </a>
                <a
                  ...
                  className="cta-btn-equal"
                  style={{ backgroundColor: "#25D366", color: "#fff", boxShadow: "0 4px 16px rgba(37,211,102,0.25)", gap: "8px" }}
          ...
          <motion.div
            ...
            style={{
              ...
              padding: "clamp(64px,9vw,96px) clamp(32px,6vw,72px)",
              textAlign: "center", minHeight: "480px",
              display: "flex", alignItems: "center", justifyContent: "center",
            }}
          >
            <div
            ...
            <div
              ...
              style={{
                position: "absolute", inset: 0,
                background: "linear-gradient(to bottom, rgba(15,30,26,0.28) 0%, rgba(15,30,26,0.65) 100%)",
              }}
            />
            <div style={{ position: "relative", zIndex: 1, maxWidth: "440px", margin: "0 auto" }}>
              <span style={{ display: "block", fontSize: "0.72rem", fontWeight: "700", letterSpacing: "3px", textTransform: "uppercase", color: "rgba(250,247,240,0.75)", marginBottom: "14px", fontFamily: "Roboto, sans-serif" }}>
                Para noivas
              </span>
