...
// ─── Constantes ───────────────────────────────────────────────────────────────
const FORM_URL = "https://forms.monday.com/forms/10354340f7be1b415ba4cf84fce6a05c?r=euc1";
const WA_URL   = "https://wa.me/351934680300?text=" +
...
function Eyebrow({ children, light, color }) {
  return (
    <p style={{
      ...
      color: color || (light ? "rgba(250,247,240,0.5)" : AZUL),
      fontFamily: "Roboto, sans-serif", margin: "0 0 14px", fontWeight: 700,
      display: "block",
    }}>
      {children}
    </p>
...
const passos = [
  {
    ...
    texto: "O vale pode ter o valor que quiser, com um mínimo de 300€. Pode personalizar o valor para se adaptar ao serviço que deseja oferecer.",
  },
  {
    n: "02",
    titulo: "Receba o cartão ilustrado",
    texto: "Enviamos o cartão por email gratuitamente, ou fisicamente por 5€ mais portes. Se preferir levantar em Coimbra, a recolha é gratuita.",
  },
  {
    n: "03",
    titulo: "Ofereça com amor",
    texto: "O cartão tem campos para escrever de quem é e para quem é. Pode oferecer em mão ou enviar diretamente à pessoa presenteada.",
  },
  {
    n: "04",
    titulo: "A pessoa usa quando quiser",
    texto: "O vale não tem data de validade. A pessoa contacta-nos quando estiver pronta, pelo site ou pelo WhatsApp, e tratamos de tudo juntos.",
  },
];
    ...
    <main style={{ backgroundColor: CREME, fontFamily: "'Roboto', sans-serif", color: ESCURO, overflowX: "hidden" }}>
      ...
      <style dangerouslySetInnerHTML={{ __html: `
        * { box-sizing: border-box; }
        ...
        .btn-outline-vale {
          display: inline-flex; align-items: center; justify-content: center;
          background: transparent; color: ${ESCURO};
        ...
        .btn-azul-vale:hover { background: ${AZUL_ESC}; transform: translateY(-3px); box-shadow: 0 10px 32px rgba(90,107,166,0.4); }
        ...
        @media (min-width: 480px) {
          .cta-row-vale { flex-direction: row; justify-content: center; align-items: center; }
        }
        ...
        .passo-card {
          ...
          background: #fff;
          border-radius: 18px;
          padding: clamp(1.4rem, 2.5vw, 1.8rem) clamp(1.2rem, 2vw, 1.6rem);
          box-shadow: 0 2px 20px rgba(123,143,199,0.12);
        ...
        .cond-item {
          ...
          padding: 1rem 0;
          border-bottom: 1px solid rgba(123,143,199,0.1);
        }
        ...
        .foto-moldura {
          ...
          box-shadow: 0 12px 48px rgba(15,30,26,0.14);
          aspect-ratio: 3/4; background: ${AZUL_FND};
        }
        .foto-moldura img {
        ...
        .entrega-card {
          ...
          background: rgba(232,236,248,0.6);
        ...
        a:focus-visible, button:focus-visible {
          outline: 3px solid ${AZUL}; outline-offset: 4px; border-radius: 4px;
        }
      `}} />
      ...
      <section style={{
        ...
        textAlign: "center",
        padding: "clamp(110px,16vw,170px) clamp(20px,5vw,48px) clamp(60px,8vw,90px)",
        background: `linear-gradient(165deg, ${AZUL_FND} 0%, rgba(232,236,248,0.45) 45%, ${CREME} 75%)`,
        position: "relative",
        overflow: "hidden",
      }}>
        ...
        <div aria-hidden="true" style={{
          ...
          borderRadius: "50%",
          background: `radial-gradient(circle, rgba(123,143,199,0.18) 0%, transparent 70%)`,
          pointerEvents: "none",
        }}/>
        <div aria-hidden="true" style={{
          ...
          borderRadius: "50%",
          background: `radial-gradient(circle, rgba(184,196,232,0.22) 0%, transparent 70%)`,
          pointerEvents: "none",
        }}/>
        ...
        >
          ...
          <p style={{
            ...
            emoldurada feita à mão, guardando para sempre as memórias de um dia especial.
          </p>

          <div className="cta-row-vale" style={{ marginBottom: "1.4rem" }}>
            <a href={FORM_URL} target="_blank" rel="noopener noreferrer" className="btn-primary-vale">
              Encomendar Vale Oferta
            </a>
            <a href="/como-funciona" className="btn-outline-vale">
              Como Funciona
            </a>
          </div>

          <p style={{ fontSize: "0.78rem", color: "#9BA89F", letterSpacing: "0.05em" }}>
            A partir de 300€ · Sem data de validade · Entrega digital gratuita
          </p>
        </motion.div>
      </section>

      {/* ══ FOTOS DO CARTÃO + TEXTO ══════════════════════════════════ */}
      <section style={{
        ...
        <div className="fotos-grid">
          ...
          <Reveal delay={0.08}>
            <div className="foto-moldura">
              <img
                ...
                alt="Cartão presente da Flores à Beira-Rio verso com condições do vale oferta"
              />
            </div>
          </Reveal>
          ...
          <Reveal delay={0.14} style={{ padding: "0.5rem 0" }}>
            ...
            <h2 style={{
              ...
              Ilustrado por uma artista de Coimbra
            </h2>
            <p style={{ lineHeight: 1.85, fontSize: "0.96rem", color: "#5A6B60", marginBottom: "1.1rem" }}>
              O cartão presente é desenhado à mão por <strong>@damais_cenas</strong>, artista local.
              Existe em duas versões: uma colorida e alegre, outra em tons neutros e elegantes.
            </p>
            <p style={{ lineHeight: 1.85, fontSize: "0.96rem", color: "#5A6B60", marginBottom: "1.6rem" }}>
              Pode ser enviado por email gratuitamente, ou entregue fisicamente por 5€ mais portes.
              A recolha em Coimbra é gratuita.
            </p>
            <div style={{ display: "flex", flexDirection: "column", gap: "0.7rem" }}>
              {[
                ...
                <div key={i} className="entrega-card">
                  ...
                  <div>
                    <span style={{ fontWeight: 600, fontSize: "0.88rem", color: ESCURO, fontFamily: "Roboto, sans-serif" }}>
                      {item.label}
                    </span>
                    <span style={{ color: AZUL, fontSize: "0.82rem", marginLeft: "0.5rem" }}>
                      {item.desc}
                    </span>
                  </div>
                </div>
      ...
      {/* ══ OCASIÕES — fundo azul rico ══════════════════════════════ */}
      <section style={{
        padding: "clamp(64px,10vw,100px) clamp(20px,5vw,48px)",
        background: `linear-gradient(145deg, ${AZUL} 0%, ${AZUL_ESC} 100%)`,
        color: CREME,
        position: "relative",
        overflow: "hidden",
      }}>
          ...
          <Reveal>
            <div style={{ textAlign: "center", marginBottom: "clamp(2.5rem, 5vw, 4rem)" }}>
              ...
              <h2 style={{
                ...
                lineHeight: 1.1, margin: "0 0 0.9rem",
              }}>
            ...
            {ocasioes.map((item, i) => (
              <Reveal key={i} delay={i * 0.07}>
                <article className="ocasiao-card">
                  <div style={{ fontSize: "2rem", marginBottom: "0.9rem" }} aria-hidden="true">
                    {item.emoji}
                  </div>
                  <h3 style={{
                    fontFamily: "'TAN-MEMORIES', serif",
                    ...
                    marginBottom: "0.6rem",
                    color: CREME, lineHeight: 1.2,
                  }}>
                    {item.titulo}
                  </h3>
                  <p style={{ fontSize: "0.88rem", lineHeight: 1.75, color: "rgba(250,247,240,0.8)", margin: 0 }}>
                    {item.descricao}
                  </p>
                </article>
              </Reveal>
      ...
      <section style={{
        ...
        <Reveal>
          <div aria-hidden="true" style={{
            width: "44px", height: "1px", margin: "0 auto 2rem",
            background: `linear-gradient(to right, transparent, ${AZUL}, transparent)`,
          }}/>
          <blockquote style={{
            fontFamily: "'TAN-MEMORIES', serif",
            fontSize: "clamp(1.5rem, 4vw, 2.8rem)",
            lineHeight: 1.45, maxWidth: "700px",
            margin: "0 auto 1rem", fontStyle: "italic",
            color: ESCURO,
          }}>
          ...
          <Reveal>
            <div style={{ textAlign: "center", marginBottom: "clamp(2.5rem, 5vw, 4rem)" }}>
              ...
              <h2 style={{
                ...
                lineHeight: 1.1, margin: 0, color: ESCURO,
              }}>
              ...
              <Reveal key={i} delay={i * 0.08}>
                <div className="passo-card">
                  <div style={{
                    ...
                    color: AZUL, lineHeight: 1,
                    minWidth: "60px", opacity: 0.7,
                  }} aria-hidden="true">
                    {passo.n}
                  </div>
                  <div>
                    <h3 style={{
                      fontFamily: "'TAN-MEMORIES', serif",
                      fontSize: "clamp(1rem, 2vw, 1.2rem)",
                      marginBottom: "0.5rem", color: ESCURO, lineHeight: 1.2,
                    }}>
                      {passo.titulo}
                    </h3>
                    <p style={{ fontSize: "0.92rem", lineHeight: 1.8, color: "#5A6B60", margin: 0 }}>
                      {passo.texto}
                    </p>
                  </div>
                </div>
      ...
      {/* ══ CONDIÇÕES — fundo escuro ═══════════════════════════════ */}
      <section style={{
        padding: "clamp(64px,10vw,100px) clamp(20px,5vw,48px)",
        background: `linear-gradient(145deg, ${ESCURO} 0%, #1E3530 100%)`,
        color: CREME,
        position: "relative",
        overflow: "hidden",
      }}>
        <div aria-hidden="true" style={{
          ...
          backgroundImage: `radial-gradient(circle at 80% 20%, rgba(123,143,199,0.12) 0%, transparent 50%),
                            radial-gradient(circle at 20% 80%, rgba(184,196,232,0.08) 0%, transparent 50%)`,
          pointerEvents: "none",
        }}/>
          ...
          <Reveal>
            <div style={{ textAlign: "center", marginBottom: "clamp(2.5rem, 5vw, 4rem)" }}>
              ...
              <h2 style={{
                fontFamily: "'TAN-MEMORIES', serif",
                fontSize: "clamp(2rem, 5vw, 3.2rem)",
                lineHeight: 1.1, margin: 0, color: CREME,
              }}>
            ...
            <div style={{
              ...
              {condicoes.map((cond, i) => (
                <div key={i} className="cond-item">
                  ...
                  <p style={{ fontSize: "0.94rem", lineHeight: 1.75, color: "rgba(250,247,240,0.8)", margin: 0 }}>
                    {cond}
                  </p>
                </div>
              ))}
      ...
      <section style={{
        padding: "clamp(64px,10vw,100px) clamp(20px,5vw,48px)",
        textAlign: "center",
        background: `linear-gradient(145deg, ${AZUL_FND} 0%, ${CREME} 60%)`,
      }}>
        <Reveal>
          <div aria-hidden="true" style={{
            width: "44px", height: "1px", margin: "0 auto 2rem",
          ...
          <h2 style={{
            ...
            lineHeight: 1.1,
            maxWidth: "660px", margin: "0 auto 1.2rem",
            color: ESCURO,
          }}>
          ...
          <p style={{
            ...
            Transforme um momento efémero numa obra de arte feita à mão,
            para durar uma vida inteira.
          </p>

          <div className="cta-row-vale" style={{ marginBottom: "1.2rem" }}>
            <a href={FORM_URL} target="_blank" rel="noopener noreferrer" className="btn-azul-vale">
              Encomendar Vale Oferta
            </a>
            <a href={WA_URL} target="_blank" rel="noopener noreferrer" className="btn-wa-vale">
          ...
          <p style={{ fontSize: "0.8rem", color: "#9BA89F" }}>
