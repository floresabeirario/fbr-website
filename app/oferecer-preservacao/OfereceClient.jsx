  ...
  return (
    <main style={{ backgroundColor: CREME, fontFamily: "'Google Sans', sans-serif", color: ESCURO, overflowX: "hidden" }}>
      <style dangerouslySetInnerHTML={{
        __html: `
        @import url('https://fonts.googleapis.com/css2?family=Google+Sans:ital,wght@0,400;0,500;0,600;0,700;1,400&display=swap');
        ...
        * { box-sizing: border-box; }
        ...
        .btn-primary-vale {
          ...
          text-transform: uppercase; font-family: 'Google Sans', sans-serif; transition: all 0.3s ease;
        ...
        .ocasiao-card {
          ...
          border-radius: 16px; padding: clamp(1.2rem,2vw,1.6rem) clamp(1rem,1.8vw,1.4rem);
        ...
        .hero-foto-bg::after {
          ...
          background: linear-gradient(to top, rgba(10,20,16,0.88) 0%, rgba(10,20,16,0.55) 45%, rgba(10,20,16,0.15) 100%);
        }
        ...
        .entrega-texto strong { display: block; font-weight: 600; font-size: 0.88rem; color: ${ESCURO}; font-family: 'Google Sans', sans-serif; margin-bottom: 2px; }
        .entrega-texto span { font-size: 0.83rem; color: #5A6B60; line-height: 1.5; }

        /* Condições inline no cartão */
        .cond-cartao-item { display: flex; gap: 0.7rem; align-items: flex-start; padding: 0.65rem 0; border-bottom: 1px solid rgba(123,143,199,0.1); }
        .cond-cartao-item:last-child { border-bottom: none; }
