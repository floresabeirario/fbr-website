...
export default function BeforeAfterSlider() {
  ...
  return (
    <motion.div initial={{ opacity: 0, y: 24 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.8, ease: [0.16, 1, 0.3, 1] }}>
      ...
      >
        <Image fill src="/quadro.webp" alt="Quadro de flores preservadas, depois" sizes="(max-width: 760px) 100vw, 760px" style={{ objectFit: "cover" }} draggable={false} />
        <div style={{ position: "absolute", inset: 0, clipPath: `inset(0 ${100 - position}% 0 0)`, willChange: "clip-path" }}>
          <Image fill src="/ramo.webp" alt="Ramo de flores, antes" sizes="(max-width: 760px) 100vw, 760px" style={{ objectFit: "cover" }} draggable={false} />
        </div>
