...
const SUBPAGES = [
  {
    ...
    accent: "#3D6B5E",
    accentLight: "rgba(61,107,94,0.12)",
    n: "01",
  },
  {
    href: "/como-funciona",
    ...
    title: "Como Funciona",
    desc: "Cinco passos desde a reserva até ao quadro emoldurado em casa. Pagamento em três prestações, composição aprovada por si antes de selar.",
    img: "/prensa.webp",
    imgAlt: "Processo de prensagem botânica artesanal — Como Funciona",
    cta: "Ver o processo",
    accent: "#C8522A",
    accentLight: "rgba(200,82,42,0.1)",
    n: "02",
  },
  {
  ...
  },
  {
    ...
    cta: "Saber mais",
    accent: "#1B4B6B",
    accentLight: "rgba(27,75,107,0.1)",
    n: "04",
  },
];

// ─── Motivos / trust signals ──────────────────────────────────────────────────
const MOTIVOS = [
  {
...
const SubCard = ({ item, index }) => (
  ...
  >
    <a
      href={item.href}
      style={{ display: "block", textDecoration: "none", borderRadius: "20px", overflow: "hidden", position: "relative", boxShadow: "0 8px 40px rgba(0,0,0,0.12)" }}
      ...
      <main style={{ backgroundColor: "#FAF7F0", overflowX: "hidden" }}>
        <style dangerouslySetInnerHTML={{
          ...
          * { box-sizing: border-box; }
          ...
          .eyebrow {
            ...
            color: #3D6B5E; margin-bottom: 12px; font-family: Roboto, sans-serif;
          }

          .text-link {
            color: #3D6B5E; font-weight: 600; text-decoration: none;
          ...
          .btn-primary:hover { background: #1E2D2A; transform: translateY(-2px); }
          ...
          .hero-pf-bg::after {
            ...
            background: linear-gradient(to top, rgba(10,22,18,0.92) 0%, rgba(10,22,18,0.55) 45%, rgba(10,22,18,0.14) 100%);
          }
          .hero-pf-text {
        ...
        <section className="hero-pf" aria-label="Preservação de flores — arte botânica artesanal">
          <div className="hero-pf-bg">
            <img
              src="/joanaceu.webp"
              alt="Quadro de flores prensadas — Flores à Beira-Rio, Coimbra"
              fetchPriority="high"
            />
          </div>
          <div className="hero-pf-text">
            ...
            >
              <p style={{ fontSize: "0.58rem", letterSpacing: "3.5px", textTransform: "uppercase", color: "rgba(250,247,240,0.55)", fontFamily: "Roboto, sans-serif", margin: "0 0 14px", fontWeight: 700 }}>
              ...
              <h1 style={{ fontFamily: "'TAN-MEMORIES', serif", fontSize: "clamp(2.6rem,7vw,5.2rem)", lineHeight: 1.03, color: "#FAF7F0", margin: "0 0 clamp(1rem,2.5vw,1.6rem)", textShadow: "0 2px 20px rgba(0,0,0,0.6)" }}>
                Preservação de<br />
                <em style={{ fontStyle: "italic", color: "#8BA888" }}>Flores</em>
              </h1>
              <p style={{ fontSize: "clamp(0.93rem,1.8vw,1.08rem)", lineHeight: 1.88, maxWidth: "480px", color: "rgba(250,247,240,0.86)", margin: "0 auto clamp(1.8rem,3.5vw,2.8rem)", textShadow: "0 1px 12px rgba(0,0,0,0.5)" }}>
                Transformamos flores com valor emocional em quadros de arte botânica que duram décadas. Bouquets de casamento, flores de batizado, homenagens — cada peça é única, feita à mão com vidro museu anti-UV.
              </p>
              <div className="cta-row" style={{ marginBottom: "clamp(1.6rem,3vw,2.4rem)" }}>
                <a href={FORM_URL} target="_blank" rel="noopener noreferrer" className="btn-primary">
                  Reservar a Minha Data
                </a>
                <a href={WA_URL_NOIVA} target="_blank" rel="noopener noreferrer" className="btn-wa">
              ...
              <div style={{ display: "flex", flexWrap: "wrap", justifyContent: "center", gap: "20px", fontSize: "0.8rem" }}>
                {[
                  ...
                  <a key={i} href={l.href} style={{ color: "rgba(139,168,136,0.9)", fontWeight: 600, textDecoration: "none", borderBottom: "1px solid rgba(139,168,136,0.3)", paddingBottom: "1px", fontFamily: "Roboto, sans-serif", transition: "border-color 0.2s" }}>
                    {l.label}
                  </a>
                ))}
              </div>
        ...
        <section
          ...
          style={{ padding: "clamp(56px,9vw,88px) clamp(20px,5vw,48px)", background: "linear-gradient(160deg, #EDF2E8 0%, #F5F9F3 40%, #FAF7F0 100%)" }}
        >
          <div style={{ maxWidth: "780px", margin: "0 auto" }}>
            ...
            >
              ...
              <h2 style={{ fontFamily: "'TAN-MEMORIES', serif", fontSize: "clamp(1.9rem,4.5vw,3.2rem)", color: "#1E2D2A", margin: "0 0 clamp(16px,2.5vw,24px)", lineHeight: 1.1 }}>
                ...
                <em style={{ fontStyle: "italic", color: "#3D6B5E" }}>de flores?</em>
              </h2>
              <div style={{ color: "#5A6B60", fontSize: "clamp(0.95rem,1.8vw,1.05rem)", lineHeight: 1.9 }}>
                <p style={{ margin: "0 0 16px" }}>
                  A preservação de flores é o processo de transformar flores frescas com valor emocional numa obra de arte botânica que dura décadas — sem perder a cor, a forma nem a essência do momento.
                </p>
                <p style={{ margin: "0 0 16px" }}>
                  Na Flores à Beira-Rio, usamos exclusivamente <strong style={{ color: "#1E2D2A" }}>prensagem botânica artesanal</strong> — o método mais natural e mais sustentável. Cada pétala é tratada individualmente, sem resinas, sem químicos sintéticos, com materiais de conservação museu.
                </p>
                <p style={{ margin: 0 }}>
                  O resultado é um <strong style={{ color: "#1E2D2A" }}>quadro emoldurado com vidro museu UltraVue® anti-UV</strong>, feito à medida, pronto a pendurar na parede de casa — e a durar toda uma vida.
                </p>
              </div>
            </motion.div>
          </div>
          ...
          <div style={{ maxWidth: "1100px", margin: "0 auto" }}>
            ...
            >
              ...
              <h2 style={{ fontFamily: "'TAN-MEMORIES', serif", fontSize: "clamp(1.9rem,4.5vw,3rem)", color: "#1E2D2A", margin: 0, lineHeight: 1.1 }}>
                ...
                <em style={{ fontStyle: "italic", color: "#3D6B5E" }}>de saber</em>
              </h2>
            </motion.div>
        ...
        <section
          ...
          style={{ padding: "clamp(48px,7vw,76px) clamp(20px,5vw,48px)", background: "linear-gradient(170deg, #1E2D2A 0%, #243D33 50%, #1E2D2A 100%)", position: "relative", overflow: "hidden" }}
        >
          <div aria-hidden="true" style={{ position: "absolute", top: "50%", left: "50%", transform: "translate(-50%,-50%)", width: "700px", height: "700px", background: "radial-gradient(circle, rgba(61,107,94,0.12) 0%, transparent 65%)", borderRadius: "50%", pointerEvents: "none" }} />
          ...
          <div style={{ maxWidth: "1000px", margin: "0 auto", position: "relative", zIndex: 1 }}>
            ...
            >
              <span style={{ display: "block", fontSize: "0.58rem", fontWeight: 700, letterSpacing: "3.5px", textTransform: "uppercase", color: "#5C8A6A", marginBottom: "12px", fontFamily: "Roboto, sans-serif" }}>Que tipo de flores preservamos</span>
              <h2 style={{ fontFamily: "'TAN-MEMORIES', serif", fontSize: "clamp(1.9rem,4.5vw,3rem)", color: "#FAF7F0", margin: 0, lineHeight: 1.1 }}>
                ...
                <em style={{ fontStyle: "italic", color: "#8BA888" }}>uma memória eterna</em>
              </h2>
            </motion.div>
            ...
            <div className="ocasioes-grid">
              {OCASIOES.map((item, i) => (
                ...
                >
                  <a href={item.href} style={{ display: "block", textDecoration: "none", padding: "clamp(16px,2.5vw,22px)", borderRadius: "14px", backgroundColor: "rgba(250,247,240,0.05)", border: "1px solid rgba(250,247,240,0.08)", transition: "background 0.25s, border-color 0.25s" }}
                    onMouseEnter={e => { e.currentTarget.style.backgroundColor = "rgba(61,107,94,0.15)"; e.currentTarget.style.borderColor = "rgba(139,168,136,0.25)"; }}
                    onMouseLeave={e => { e.currentTarget.style.backgroundColor = "rgba(250,247,240,0.05)"; e.currentTarget.style.borderColor = "rgba(250,247,240,0.08)"; }}
                  >
        ...
        >
          <div style={{ maxWidth: "1100px", margin: "0 auto" }}>
            ...
            >
              ...
              <h2 style={{ fontFamily: "'TAN-MEMORIES', serif", fontSize: "clamp(1.9rem,4.5vw,3rem)", color: "#1E2D2A", margin: 0, lineHeight: 1.1 }}>
                Feito para durar<br />
                <em style={{ fontStyle: "italic", color: "#3D6B5E" }}>toda uma vida</em>
              </h2>
            </motion.div>
        ...
        {/* ══ CTA FINAL ══════════════════════════════════════════════════════════ */}
        <section
          aria-label="Reservar preservação de flores"
          style={{ padding: "clamp(64px,10vw,100px) clamp(20px,5vw,48px)", background: "linear-gradient(145deg, #F5EDE0 0%, #FAF7F0 55%, #F0E8D8 100%)", textAlign: "center" }}
        >
          <motion.div
            initial={{ opacity: 0, y: 18 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            <div aria-hidden="true" style={{ width: "44px", height: "1px", margin: "0 auto 28px", background: "linear-gradient(to right, transparent, #3D6B5E, transparent)" }} />
            ...
            <p style={{ color: "#5A6B60", lineHeight: 1.88, fontSize: "clamp(0.9rem,2vw,1rem)", margin: "0 0 34px", fontFamily: "Roboto, sans-serif" }}>
              As vagas são limitadas, especialmente entre maio e setembro. Preencha o formulário de reserva e respondemos em 72 horas com a confirmação e todas as instruções.
            </p>
            ...
            <div style={{ display: "flex", flexWrap: "wrap", justifyContent: "center", gap: "20px", fontSize: "0.82rem" }}>
              {[
                ...
                <a key={i} href={l.href} className="text-link" style={{ fontFamily: "Roboto, sans-serif" }}>
                  {l.label}
                </a>
              ))}
            </div>
