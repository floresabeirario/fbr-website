...
// Página do formulário de "Emoldurar Flores Já Secas". Reutiliza o layout e
// as classes CSS da página de reserva de preservação (rp-* e pf-*) + uns
// acrescentos próprios para o upload de fotos (EmoldurarReservar.css).

import Link from "next/link";
import Image from "next/image";
import { m } from "framer-motion";
import { useTranslations, useLocale } from "next-intl";
import EmoldurarForm from "./EmoldurarForm";
    ...
    <main className="rp-page emoldurar-theme">
      ...
      <div className="rp-hero">
        ...
        <m.div className="rp-hero-content hero-enter">
          ...
          <h1 className="rp-title">{t("h1")}</h1>
          <p className="rp-sub">{t("heroSub")}</p>
          <Link href={servicoHref} className="rp-info-link">
