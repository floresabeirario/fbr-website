...
function RelatedCard({ post }) {
  return (
    ...
    >
      <div style={{ aspectRatio: "16/9", overflow: "hidden", backgroundColor: "var(--sage)", position: "relative" }}>
      ...
      <div style={{ padding: "16px 18px 20px" }}>
        ...
        <p style={{ color: "var(--mid-l)", fontSize: "0.78rem", fontFamily: "Roboto, sans-serif", margin: 0 }}>
    ...
    <div style={{ backgroundColor: "var(--cream)", overflowX: "clip" }}>
      ...
      >
        <div style={{ maxWidth: "760px", margin: "0 auto" }}>
          <motion.div initial={{ opacity: 0, y: 22 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, ease: [0.16, 1, 0.3, 1] }}>
            ...
            <h1 style={{ fontFamily: "'TAN-MEMORIES', serif", fontSize: "clamp(2rem,6vw,3.6rem)", color: "var(--green-d)", margin: "0 0 18px", lineHeight: 1.08 }}>
              {post.title}
            </h1>
            <p style={{ color: "var(--mid)", fontSize: "clamp(1rem,2vw,1.12rem)", lineHeight: 1.85, margin: 0 }}>
              {post.description}
            </p>
          </motion.div>
        </div>
      ...
      <div style={{ maxWidth: "960px", margin: "0 auto", padding: "0 clamp(20px,5vw,48px)" }}>
        <motion.div
          ...
          style={{ position: "relative", borderRadius: "20px", overflow: "hidden", boxShadow: "0 16px 56px rgba(30,45,42,0.12)", aspectRatio: "16/7", backgroundColor: "var(--sage)" }}
        >
      ...
      >
        ...
        <div style={{ marginTop: "32px", padding: "20px 22px", backgroundColor: "rgba(61,107,94,0.05)", borderRadius: "14px", display: "flex", alignItems: "center", gap: "14px" }}>
          <div style={{ width: "44px", height: "44px", borderRadius: "50%", backgroundColor: "var(--green)", flexShrink: 0, display: "flex", alignItems: "center", justifyContent: "center" }}>
            <span style={{ fontFamily: "'TAN-MEMORIES', serif", fontSize: "1.1rem", color: "var(--cream)" }} aria-hidden="true">
