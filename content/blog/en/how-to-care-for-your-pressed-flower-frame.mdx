...
This is why we offer **UltraVue® anti-UV museum glass** as an option on any frame. This glass blocks UV rays, the same standard used in museums to protect works of art. It is also anti-reflective, which means the colours of the flowers are more visible and the frame does not create distracting glare on the wall.
...
If your frame has museum glass, its anti-reflective treatment is sensitive to harsh chemical products.
...
The frame is robust, but the glass can break if the frame falls from a considerable height.
